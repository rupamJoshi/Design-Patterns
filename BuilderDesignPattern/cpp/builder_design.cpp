...
class JSONBuilder
{
    ...
    void add(string name,char data) {
        _char.push_front(pair<string,char>(name,data));
    }

    void add(string name,unsigned char data) {
    ...
    void add(string name,unsigned int data) {
...
int main() {
    ...
    string json;
    jsonBuilder.add("string","Sameer");
    jsonBuilder.add("char",'2');
    jsonBuilder.add("int",122);
